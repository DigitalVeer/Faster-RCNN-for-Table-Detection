"""Region-of-interest geometry: IoU, non-max suppression and RPN->ROI decoding.

Pure NumPy / math -- no deep-learning framework required, which is what makes
...
def non_max_suppression_fast(boxes, probs, overlap_thresh=0.9, max_boxes=300):
    ...
    #           larger than overlap_threshold, delete the box from list
...
def calc_iou(R, img_data, C, class_mapping):
    ...
    for ix in range(R.shape[0]):
        ...
        y_class_num.append(list(class_label))
        ...
        if cls_name != 'bg':
            ...
            y_class_regr_coords.append(list(coords))
            y_class_regr_label.append(list(labels))
        else:
            y_class_regr_coords.append(list(coords))
            y_class_regr_label.append(list(labels))
